...
export const EVENTS: TimeEvent[] = [
  ...
  { id: 'hcm-alert', scale: 'flight', t: U(2014, 2, 7, 17, 39, 3), label: 'Ho Chi Minh ACC queries KL (delayed alert)', kind: 'flight' },
  { id: 'satcom-outage', scale: 'flight', t: U(2014, 2, 7, 18, 3, 0), label: 'SATCOM unpowered (02:03-02:25 UTC+8 gap)', kind: 'handshake' },
  ...
  { id: 'mh88-relay', scale: 'flight', t: U(2014, 2, 7, 17, 57, 49), label: 'Relay attempt via other aircraft (MH88 "mumbling", uncorroborated)', kind: 'flight' },
  ...
  { id: 'emirates-nearmiss', scale: 'flight', t: U(2014, 2, 7, 20, 2, 15), label: 'Near-miss: EK407/EY461 formation (CAPTIO model)', kind: 'flight' },
  ...
  { id: 'detresfa', scale: 'flight', t: U(2014, 2, 7, 22, 32, 0), label: 'DETRESFA declared (SAR launched)', kind: 'flight' },
  ...
  { id: 'final-burst', scale: 'flight', t: U(2014, 2, 8, 0, 19, 37), label: 'Final transmission (08:19:37 UTC+8, arc-excluded)', kind: 'handshake' },
